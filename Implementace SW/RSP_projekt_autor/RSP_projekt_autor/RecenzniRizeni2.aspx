...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" Runat="Server">
     <h4 class="auto-style1">Články odeslané do RR, čekající na zahájení RR:</h4>
     <p class="auto-style1">&nbsp;</p>
     <p class="auto-style1">
         <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource1" EmptyDataText="Aktuálně nejsou žádné data k zobrazení." ForeColor="#333333" GridLines="None" CssClass="auto-style5" Width="925px">
...
WHERE (Clanky_Status.Id_cl_status = 2)"></asp:SqlDataSource>
     ...
     <p class="auto-style1"><strong>Zvolte prosím datum zahájení RR:</strong></p>
     <p class="auto-style1">&nbsp;</p>
     <p class="auto-style1">
     ...
     <p class="auto-style1">
         <asp:Label ID="lbl_zahRR" runat="server" ForeColor="Blue" Text="Vyberte datum!"></asp:Label>
     </p>
     <p class="auto-style1">&nbsp;</p>
     <p class="auto-style1">
...
<p class="auto-style1">&nbsp;</p>
   ...
   <h4 class="auto-style1">Články u kterých je již zahájené RR, ale nejsou přiřazeni recenzenti:</h4>
     <p class="auto-style1">&nbsp;</p>
     <p class="auto-style1">
         <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource2" EmptyDataText="Aktuálně nejsou žádné data k zobrazení." ForeColor="#333333" GridLines="None">
             <AlternatingRowStyle BackColor="White" />
             <Columns>
...
WHERE (Clanky_Status.Id_cl_status = 3)"></asp:SqlDataSource>
    ...
    <h4 class="auto-style1">Články, u kterých probíhá RR:</h4>
     <p class="auto-style1">&nbsp;</p>
     <p class="auto-style1">
