...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" Runat="Server">
    ...
    <p class="auto-style5">
        <div class="auto-style6">
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="KdoreseniClanky" ForeColor="#333333" GridLines="None">
...
WHERE (Clanky_Status.Id_cl_status = 1 OR Clanky_Status.Id_cl_status = 5)"></asp:SqlDataSource>
    </p>
