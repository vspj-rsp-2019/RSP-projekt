...
<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">Zprávy od Redaktora</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" Runat="Server">
    <br />
    <h1 class="auto-style1">Zprávy od redaktora</h1><br />
    <table class="auto-style2">
        <tr>
            <td>
            <div>
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" EmptyDataText="Neevidujeme žádné záznamy." OnSelectedIndexChanged="GridView1_SelectedIndexChanged" HorizontalAlign="Center">
