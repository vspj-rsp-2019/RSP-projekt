...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" Runat="Server">
    ...
    <h2 class="auto-style1">Zprávy autorům</h2>
   <br/>
    ...
    <br />
        ...
        <tr>
            <td class="auto-style9"><strong>Autor:</strong><asp:Label ID="Lbl_autor" runat="server" Visible="False"></asp:Label>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="Btn_posliZpravu" runat="server" OnClick="Btn_posliZpravu_Click" Text="Pošli zprávu" />
                        ...
                        <h2 class="auto-style1">Předchozí zprávy s autorem</h2>
