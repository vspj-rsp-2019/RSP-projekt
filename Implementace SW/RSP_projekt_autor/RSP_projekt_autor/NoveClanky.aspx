...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" Runat="Server">
    <br /><h2 class="auto-style5">Nově podané články od autorů k dalšímu zpracování</h2><br />
    <div>
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="NoveClankyRedaktorovi" EmptyDataText="Nejsou žádné nové data." ForeColor="#333333" GridLines="None" OnRowCommand="GridView1_RowCommand" HorizontalAlign="Center">
    ...
    <p class="auto-style1" style="text-align:center">
        ...
        <asp:Button ID="btn_zamitnoutcl" runat="server" BackColor="Red" OnClick="btn_zamitnoutcl_Click" Text="Zamítnout článek" ForeColor="White" />
    </p><br />
    <p class="auto-style5"><asp:Label ID="lbl_stav" runat="server" ForeColor="#66FF33" Text="sss" Visible="False"></asp:Label></p>
    <br /><br /><br /><br /><br /><br />
</asp:Content>