...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" Runat="Server">
    ...
    <h4 class="auto-style5">
        ...
        Kontrola uzávěrky - Upozornění na končící datum uzávěrky pro sběr příspěvků do jednotlivých čísel časopisu</h4>
<p class="auto-style5">
        
        &nbsp;</p>
<p class="auto-style5">
        
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="CheckUzaverky" EmptyDataText="Aktuálně neevidujeme končící termíny." ForeColor="#333333" GridLines="None">
...
<p class="auto-style5">
        ...
        <asp:Button ID="btn_zobrUzaverky" runat="server" OnClick="btn_zobrUzaverky_Click" Text="Zobraz všechny uzávěrky" Width="278px" />
</p>
<p class="auto-style5">
        
        <asp:Button ID="brn_skrytUz" runat="server" OnClick="brn_skrytUz_Click" Text="Skrýt všechny uzávěrky" Visible="False" Width="278px" />
</p>
<p class="auto-style5">
...
<p class="auto-style5">
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="VsechnyUzaverky" ForeColor="#333333" GridLines="None" Visible="False">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="Termin_uzaverky" HeaderText="Termín uzávěrky" SortExpression="Termin_uzaverky" />
                <asp:BoundField DataField="Name" HeaderText="Vydání" SortExpression="Name" />
